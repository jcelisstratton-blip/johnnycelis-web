...
export default function ServiciosPage() {
  ...
  const serviciosDetallados = [
    ...
    },
    {
      ...
      desc: "Escalamos tu adquisición de clientes corporativos. Utilizamos inteligencia artificial para extraer bases de datos, enriquecer leads e hiper-personalizar campañas de Cold Email y LinkedIn a escala masiva, llenando tu embudo con reuniones cualificadas.",
    ...
    {
      id: "orquestacion",
      title: "Orquestación Operativa",
      subtitle: "El Sistema Nervioso de tu Empresa",
      desc: "Eliminamos el trabajo manual y la doble digitación. Conectamos tus CRMs, ERPs, pasarelas de pago y herramientas de comunicación bajo una lógica de flujos operativos infalibles que trabajan en segundo plano sin descanso.",
      bullets: ["Flujos de trabajo complejos sin intervención humana", "Ahorro masivo en costos de licencias y operativos", "Actualización de inventarios y reportes automáticos", "Alertas en tiempo real para tu equipo ejecutivo"]
    },
    {
      id: "chatbots",
      title: "Chatbots de Conversión",
      subtitle: "Asistentes Transaccionales en WhatsApp y Web",
      desc: "No más chatbots de 'Oprime 1 para ventas'. Desarrollamos asistentes omnicanal entrenados con el contexto de tu empresa, capaces de guiar al cliente por el embudo, procesar pedidos y responder objeciones como tu mejor cerrador.",
    ...
    <main style={{ backgroundColor: '#000', color: '#fff', minHeight: '100vh', fontFamily: 'Inter, system-ui, sans-serif', margin: 0, padding: 0, overflowX: 'hidden' }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        * { box-sizing: border-box; scroll-behavior: smooth; }
        ...
        /* REDES SOCIALES FIJO MÓVIL */
        .social-container { display: flex; justify-content: center; flex-wrap: wrap; gap: 25px; margin-bottom: 80px; }
        ...
        @media (max-width: 600px) {
          .social-container { gap: 12px; margin-bottom: 50px; }
      ...
      <div className={`wa-chat-box ${chatOpen ? 'open' : ''}`}>
        ...
        <div className="wa-body">
          <div className="wa-msg-bot"><strong style={{color: electricPurple}}>Asistente Virtual:</strong><br/><br/>Hola, ¿En qué servicio de automatización necesitas profundizar hoy?</div>
        ...
        {serviciosDetallados.map((srv, i) => (
          <div key={srv.id} id={srv.id} className="service-block">
            ...
            <div className="service-visual">
              <div className="visual-box">0{i+1}</div>
            </div>
          </div>
        ))}
      </section>
