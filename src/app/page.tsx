...
export default function Home() {
  ...
  return (
    <main className="bg-black text-white min-h-screen font-sans selection:bg-[#9D00FF]">
      
      {/* ESTILOS DE MOVIMIENTO Y UX */}
      <style dangerouslySetInnerHTML={{ __html: `
        .hero-video-overlay { background: linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,1)); }
        ...
        .glass-card { background: rgba(255, 255, 255, 0.02); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.05); transition: 0.5s; }
        .glass-card:hover { border-color: ${electricPurple}; background: rgba(157,0,255,0.05); }
        @media (max-width: 640px) { .mobile-title { font-size: 3.5rem !important; } .mobile-padding { padding-top: 120px !important; } }
      `}} />

      {/* NAV UX (Se vuelve compacto al hacer scroll) */}
      <nav style={{ 
        position: 'fixed', top: 0, width: '100%', zIndex: 1000, 
        padding: scrolled ? '15px 30px' : '25px 40px', 
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="mobile-padding pt-20">
          <h1 className="mobile-title font-black italic uppercase leading-[0.85] tracking-tighter" style={{ fontSize: 'clamp(3.5rem, 10vw, 9rem)' }}>
          ...
          <p className="max-w-2xl mx-auto mt-8 text-gray-400 text-lg md:text-xl font-light leading-relaxed">
            Sistemas de <span className="text-white font-bold">Agentes de Voz e IA</span> que transforman Stratt-On Agency en una maquinaria de ingresos autónoma.
          </p>
          <div className="mt-12">
            <a href="#agendar" className="bg-[#9D00FF] text-white font-black px-12 py-5 tracking-widest electric-btn no-underline uppercase">
      ...
      <section id="servicios" className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            { t: "Outbound Pro", d: "Prospección masiva y calificación de leads sin intervención humana." },
      ...
      {/* CALCULADORA DE ROI (UX Blanca para Contraste) */}
      ...
      <footer id="agendar" className="py-32 bg-black text-center px-6 border-t border-white/5">
        ...
        <a href="https://calendly.com/tu-link" className="bg-[#9D00FF] text-white font-black px-16 py-6 tracking-widest electric-btn no-underline inline-block uppercase">
          Reservar Llamada
        </a>
